...
public class ReferralFeeRepository : BaseRepository<ReferralFee, Guid>, IReferralFeeRepository
{
    public ReferralFeeRepository(PayrollDbContext context) : base(context) { }
}