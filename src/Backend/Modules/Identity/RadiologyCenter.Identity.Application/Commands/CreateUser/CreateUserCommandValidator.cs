...
public class CreateUserCommandValidator : AbstractValidator<CreateUserCommand>
{
    public CreateUserCommandValidator()
    {
        ...
        RuleFor(x => x.Email).NotEmpty().WithErrorCode(SharedCodes.Shared.FieldRequired).EmailAddress().WithErrorCode(SharedCodes.Shared.InvalidEmail).MaximumLength(200).WithErrorCode(SharedCodes.Shared.TextTooLong);
