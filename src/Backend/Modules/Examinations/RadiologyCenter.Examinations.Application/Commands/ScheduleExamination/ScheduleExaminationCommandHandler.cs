...
public static class ScheduleExaminationCommandHandler
{
        ...
        CancellationToken ct)
    {
        ...
        var scheduledEnd = scheduledAtUtc.AddMinutes(durationMinutes);
        ...
        var (isConflict, resource) = await ExaminationOverlapChecker.FindConflictAsync(
            ...
            scheduledAtUtc, scheduledEnd, excludeExaminationId: examination.Id, ct);
        ...
        examination.Schedule(scheduledAtUtc, durationMinutes);
